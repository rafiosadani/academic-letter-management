                            ...
                            @if(auth()->user()->hasRole('Mahasiswa'))
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <x-form.input
                                            ...
                                            helper="Masukkan Nama lengkap orang tua"
                                    />
                                    ...
                                    <x-form.input
                                            ...
                                            placeholder="Masukkan 18 digit NIP atau tanda (-)"
                                            helper="Masukkan 18 digit NIP tanpa spasi. Gunakan tanda (-) jika orang tua tidak memiliki NIP/Pensiunan."
                                    />

                                    {{-- Parent Rank (Pangkat/Golongan) --}}
                                    <div x-data="{
                                        selectedValue: '{{ old('parent_rank', $user->profile->parent_rank ?? '') }}',
                                        predefinedRanks: [
                                        ...
                                        isOther: {{ (old('parent_rank', $user->profile->parent_rank ?? '') && !in_array(old('parent_rank', $user->profile->parent_rank ?? ''), [
                                            'Juru Muda / I a', 'Juru Muda Tingkat I / I b', 'Juru / I c', 'Juru Tingkat I / I d',
                                            'Pengatur Muda / II a', 'Pengatur Muda Tingkat I / II b', 'Pengatur / II c', 'Pengatur Tingkat I / II d',
                                            'Penata Muda / III a', 'Penata Muda Tingkat I / III b', 'Penata / III c', 'Penata Tingkat I / III d',
                                            'Pembina / IV a', 'Pembina Tingkat I / IV b', 'Pembina Utama Muda / IV c', 'Pembina Utama Madya / IV d', 'Pembina Utama / IV e'
                                        ...
                                        <label class="block">
                                            <span class="font-medium text-slate-600 dark:text-navy-100">Pangkat / Golongan</span>
                                            <select
                                                @change="if ($event.target.value === 'Lainnya') { isOther = true; selectedValue = ''; } else { isOther = false; selectedValue = $event.target.value; }"
                                                name="parent_rank"
                                            ...
                                            >
                                                ...
                                                <optgroup label="Golongan I">
                                                    <option value="Juru Muda / I a" :selected="selectedValue == 'Juru Muda / I a'">Juru Muda / I a</option>
                                                    <option value="Juru Muda Tingkat I / I b" :selected="selectedValue == 'Juru Muda Tingkat I / I b'">Juru Muda Tingkat I / I b</option>
                                                    <option value="Juru / I c" :selected="selectedValue == 'Juru / I c'">Juru / I c</option>
                                                    <option value="Juru Tingkat I / I d" :selected="selectedValue == 'Juru Tingkat I / I d'">Juru Tingkat I / I d</option>
                                                </optgroup>

                                                {{-- Golongan II --}}
                                                <optgroup label="Golongan II">
                                                    <option value="Pengatur Muda / II a" :selected="selectedValue == 'Pengatur Muda / II a'">Pengatur Muda / II a</option>
                                                    <option value="Pengatur Muda Tingkat I / II b" :selected="selectedValue == 'Pengatur Muda Tingkat I / II b'">Pengatur Muda Tingkat I / II b</option>
                                                    <option value="Pengatur / II c" :selected="selectedValue == 'Pengatur / II c'">Pengatur / II c</option>
                                                    <option value="Pengatur Tingkat I / II d" :selected="selectedValue == 'Pengatur Tingkat I / II d'">Pengatur Tingkat I / II d</option>
                                                </optgroup>

                                                {{-- Golongan III --}}
                                                <optgroup label="Golongan III">
                                                    <option value="Penata Muda / III a" :selected="selectedValue == 'Penata Muda / III a'">Penata Muda / III a</option>
                                                    <option value="Penata Muda Tingkat I / III b" :selected="selectedValue == 'Penata Muda Tingkat I / III b'">Penata Muda Tingkat I / III b</option>
                                                    <option value="Penata / III c" :selected="selectedValue == 'Penata / III c'">Penata / III c</option>
                                                    <option value="Penata Tingkat I / III d" :selected="selectedValue == 'Penata Tingkat I / III d'">Penata Tingkat I / III d</option>
                                                </optgroup>

                                                {{-- Golongan IV --}}
                                                <optgroup label="Golongan IV">
                                                    <option value="Pembina / IV a" :selected="selectedValue == 'Pembina / IV a'">Pembina / IV a</option>
                                                    <option value="Pembina Tingkat I / IV b" :selected="selectedValue == 'Pembina Tingkat I / IV b'">Pembina Tingkat I / IV b</option>
                                                    <option value="Pembina Utama Muda / IV c" :selected="selectedValue == 'Pembina Utama Muda / IV c'">Pembina Utama Muda / IV c</option>
                                                    <option value="Pembina Utama Madya / IV d" :selected="selectedValue == 'Pembina Utama Madya / IV d'">Pembina Utama Madya / IV d</option>
                                                    <option value="Pembina Utama / IV e" :selected="selectedValue == 'Pembina Utama / IV e'">Pembina Utama / IV e</option>
                                                </optgroup>
                                                <option value="Lainnya" :selected="isOther">-- Lainnya / Input Manual --</option>
                                            </select>

                                            <div x-show="isOther" x-cloak class="flex gap-2 mt-1.5">
                                                <input
                                                        type="text"
                                                        :name="isOther ? 'parent_rank' : ''"
                                                        x-model="selectedValue"
                                                        class="form-input flex-1 rounded-lg border border-slate-300 bg-transparent px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                        placeholder="Ketik Pangkat / Golongan manual..."
                                                >
                                                <button type="button" @click="isOther = false; selectedValue = ''" class="btn size-10 rounded-lg p-0 hover:bg-slate-300/20">
                                                    <i class="fa-solid fa-xmark"></i>
                                                </button>
                                            </div>
                                        </label>
                                        @error('parent_rank') <span class="text-tiny-plus text-error mt-1 block">{{ $message }}</span> @enderror
                                    </div>
