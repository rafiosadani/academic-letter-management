<x-layouts.app title="Dashboard Staff Akademik" :hasPanel="false">
    ...
    {{-- Welcome Card --}}
    <x-dashboard.welcome-card :user="$user" role="Staff Akademik - Verifikator" />
    ...
    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <x-dashboard.card-stat
                ...
                :subtitle="$stats['summary']['success_rate'] . '% approval rate'"
                color="primary"
        />
    ...
    <div class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <x-dashboard.card-chart title="Pending by Priority" chartId="priority-chart" />
    ...
    <div class="card mt-4">
        ...
        <div class="grid grid-cols-1 gap-4 p-4 sm:grid-cols-3">
            ...
            <div class="rounded-lg bg-success/10 p-4">
                <p class="text-xs text-slate-400 dark:text-navy-300">Approved</p>
            ...
            <div class="rounded-lg bg-error/10 p-4">
                <p class="text-xs text-slate-400 dark:text-navy-300">Rejected</p>
    ...
    <div class="card mt-4">
        <div class="flex items-center justify-between border-b border-slate-200 px-4 py-3 dark:border-navy-500">
            ...
            <div class="flex space-x-2">
                <button class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
