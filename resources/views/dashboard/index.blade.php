...
<x-layouts.app
    ...
    >
            ...
            >
                <div class="flex justify-center sm:order-last">
                    <img
                            ...
                            src="{{ asset('assets/images/illustrations/doctor.svg') }}"
                            alt="image"
                    />
                </div>
                <div
        ...
        <div class="col-span-12 lg:col-span-4 xl:col-span-3">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-1 lg:gap-6">
                ...
                <div
                        class="card sm:order-last sm:col-span-2 lg:order-none lg:col-span-1"
                >
                    <div
                ...
                <div class="card p-4">
                    <div class="space-y-1 text-center font-inter text-xs-plus">
                        ...
                        <div class="grid grid-cols-7 pb-2">
                            <div
                                    class="text-tiny-plus font-semibold text-primary dark:text-accent-light"
                            >
                                SUN
                            </div>
                            <div
    ...
    <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        ...
        <div class="col-span-12">
            <div class="card bg-gradient-to-r from-blue-500 to-blue-600 p-5">
                <div class="flex items-center justify-between">
                    <div class="text-white">
                        <h3 class="text-xl font-semibold">
                            Selamat Datang, <span class="font-bold">{{ auth()->user()->name ?? 'User' }}</span>
                        </h3>
                        <p class="mt-2">Sistem Persuratan Akademik</p>
                        <p class="text-sm opacity-90">Kelola surat dan administrasi akademik dengan mudah</p>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3">
            <div class="card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs-plus uppercase text-slate-400 dark:text-navy-300">Total Surat</p>
                        <div class="mt-2 flex items-baseline space-x-1">
                            <p class="text-2xl font-semibold text-slate-700 dark:text-navy-100">245</p>
                            <p class="text-xs text-success">+12%</p>
                        </div>
                    </div>
                    <div class="flex size-12 items-center justify-center rounded-lg bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3">
            <div class="card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs-plus uppercase text-slate-400 dark:text-navy-300">Menunggu</p>
                        <div class="mt-2 flex items-baseline space-x-1">
                            <p class="text-2xl font-semibold text-slate-700 dark:text-navy-100">18</p>
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3">
            <div class="card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs-plus uppercase text-slate-400 dark:text-navy-300">Disetujui</p>
                        <div class="mt-2 flex items-baseline space-x-1">
                            <p class="text-2xl font-semibold text-slate-700 dark:text-navy-100">198</p>
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3">
            <div class="card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs-plus uppercase text-slate-400 dark:text-navy-300">Ditolak</p>
                        <div class="mt-2 flex items-baseline space-x-1">
                            <p class="text-2xl font-semibold text-slate-700 dark:text-navy-100">29</p>
                            <p class="text-xs text-error">-3%</p>
                        </div>
                    </div>
                ...
                <div class="is-scrollbar-hidden min-w-full overflow-x-auto">
                    <table class="is-hoverable w-full text-left">
                        ...
                        <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">16 Nov 2024</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Surat Keterangan Aktif</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Ahmad Fauzi</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        ...
                        <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">15 Nov 2024</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Surat Izin Penelitian</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Siti Nurhaliza</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        ...
                        <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">15 Nov 2024</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Surat Pengantar KP</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">Budi Santoso</td>
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                <div class="badge rounded-full bg-success/10 text-success dark:bg-success/15">
                                    Disetujui
                                </div>
                    ...
                    <a href="#"
                       class="flex items-center justify-between rounded-lg bg-slate-100 p-3 transition-colors hover:bg-slate-200 dark:bg-navy-600 dark:hover:bg-navy-500">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="font-medium text-slate-700 dark:text-navy-100">Buat Surat Baru</span>
                        </div>
                    ...
                    <a href="#"
                       class="flex items-center justify-between rounded-lg bg-slate-100 p-3 transition-colors hover:bg-slate-200 dark:bg-navy-600 dark:hover:bg-navy-500">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="font-medium text-slate-700 dark:text-navy-100">Riwayat Surat</span>
                        </div>
                        <svg class="size-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
                    ...
                    <a href="/"
                       class="flex items-center justify-between rounded-lg bg-slate-100 p-3 transition-colors hover:bg-slate-200 dark:bg-navy-600 dark:hover:bg-navy-500">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="font-medium text-slate-700 dark:text-navy-100">Kelola User</span>
                        </div>
                        <svg class="size-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
