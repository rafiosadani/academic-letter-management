    ...
    <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        <div class="col-span-12">
            ...
            <x-dashboard.welcome-card
                    :user="$user"
{{--                    image="{{ asset('images/illustrations/dean.svg') }}"--}}
                    color="from-purple-600 to-indigo-700"
            >
                <x-slot:extraInfo>
                    <div>
                        <span>Siap untuk melakukan pengesahan dokumen hari ini?</span>
                    </div>
                    <div>
                    ...
                    <p class="mt-1 opacity-80"></p>
                </x-slot:extraInfo>
                <x-slot:action>
                    <a href="{{ route('approvals.index') }}" class="btn border border-white/10 bg-white/20 text-white hover:bg-white/30">Review & Validasi TTE</a>
                </x-slot:action>
            </x-dashboard.welcome-card>
            ...
            {{-- Summary Cards --}}
            <div class="mt-4 sm:mt-5 lg:mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                <x-dashboard.card-stat
                        icon="fa-file-signature"
                        label="Menunggu TTE"
                        :value="$stats['summary']['pending_tte']"
                        subtitle="Perlu tanda tangan digital"
                        color="warning"
                />
                ...
                <x-dashboard.card-stat
                        ...
                        subtitle="Penyelesaian hari ini"
                        color="success"
                />
                ...
                <x-dashboard.card-stat
                        ...
                        subtitle="Surat selesai diproses"
                        color="primary"
                />
...
{{--            <div class="mt-4 sm:mt-5 lg:mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">--}}
{{--                <x-dashboard.card-stat--}}
...
{{--            </div>--}}
            ...
            {{-- Insights Card --}}
{{--            <div class="card mt-4 sm:mt-5 lg:mt-6 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-navy-600 dark:to-navy-700">--}}
{{--                <div class="p-4">--}}
...
{{--                                        </p>--}}
{{--                                        <p class="text-xs text-slate-400">{{ $approval->letterRequest->student->profile->student_or_employee_id }}</p>--}}
{{--                                    </div>--}}
{{--                                </td>--}}
{{--                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">--}}
{{--                                <span class="text-xs text-slate-600 dark:text-navy-200">--}}
{{--                                    {{ $approval->letterRequest->student->profile->studyProgram->degree_name ?? 'N/A' }}--}}
{{--                                </span>--}}
{{--                                </td>--}}
{{--                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">--}}
{{--                                <span class="text-xs text-slate-600 dark:text-navy-200">--}}
