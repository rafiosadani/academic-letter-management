<x-layouts.app title="Detail Pengajuan Surat">
    ...
    <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            ...
            <div class="card">
                <div class="flex items-center justify-between p-4 sm:p-5">
                    <div class="flex items-center space-x-3">
                        <div class="flex size-8 sm:size-12 items-center justify-center rounded-lg bg-{{ $letter->status_badge }}/10 text-{{ $letter->status_badge }}">
                            <i class="fa-solid fa-circle-info text-ls sm:text-2xl"></i>
                        </div>
                        <div>
                        ...
                        <div class="is-scrollbar-hidden min-w-full overflow-x-auto rounded-lg border border-slate-300 dark:border-navy-500">
                            <table class="w-full text-left">
                                ...
                                <tr class="bg-slate-200 dark:bg-navy-800">
                                    <th class="w-12 border-r border-slate-300 whitespace-nowrap px-4 py-3 sm:text-xs font-medium text-slate-800 dark:border-navy-500 dark:text-navy-100 text-center">
                                        No
                                    </th>
        ...
        <div class="hidden sm:block col-span-12 lg:col-span-4 space-y-4 sm:space-y-5">
