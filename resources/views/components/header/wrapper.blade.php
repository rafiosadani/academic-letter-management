    ...
    <div class="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden">
        ...
        <div class="flex w-full items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                ...
                <!-- Dark Mode Toggle -->
                <button class="darkmode-toggle btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    <svg
                ...
                <button class="monochrome-toggle btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
