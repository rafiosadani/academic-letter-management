...
<a
                ...
                <button
                        type="submit"
                        class="btn min-w-[7rem] {{ isset($user) ? 'bg-warning' : 'bg-primary' }} font-medium text-white hover:{{ isset($user) ? 'bg-warning-focus' : 'bg-primary-focus' }} focus:{{ isset($user) ? 'bg-warning-focus' : 'bg-primary-focus' }} active:{{ isset($user) ? 'bg-warning-focus' : 'bg-primary-focus' }}/90"
                >
