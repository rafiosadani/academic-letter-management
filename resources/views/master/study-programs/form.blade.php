...
{{--                                    <div>--}}
{{--                                        <p class="text-xs text-slate-600 dark:text-navy-200 mb-1">Nama Lengkap Program Studi:</p>--}}
{{--                                        <p class="font-medium text-slate-700 dark:text-navy-100">{{ $studyProgram->full_name }}</p>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        @endif--}}
...
{{--                <a--}}
{{--                    href="{{ route('master.study-programs.index') }}"--}}
...
{{--                <button--}}
{{--                    type="submit"--}}
{{--                    class="btn min-w-[7rem] {{ isset($studyProgram) ? 'bg-warning' : 'bg-primary' }} font-medium text-white hover:{{ isset($studyProgram) ? 'bg-warning-focus' : 'bg-primary-focus' }} focus:{{ isset($studyProgram) ? 'bg-warning-focus' : 'bg-primary-focus' }} active:{{ isset($studyProgram) ? 'bg-warning-focus' : 'bg-primary-focus' }}/90"--}}
{{--                >--}}
{{--                    <i class="fa-solid fa-check mr-2"></i>--}}
{{--                    {{ isset($studyProgram) ? 'Update Program Studi' : 'Simpan Program Studi' }}--}}
{{--                </button>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </form>--}}
...
<x-layouts.app :title="isset($studyProgram) ? 'Edit Program Studi: ' . $studyProgram->name : 'Tambah Program Studi Baru'">
    ...
    {{-- FORM (Ditambahkan 'grow' agar formulir mengambil sisa ruang di dalam $slot) --}}
    <form
            method="POST"
            action="{{ isset($studyProgram) ? route('master.study-programs.update', $studyProgram) : route('master.study-programs.store') }}"
    ...
    >
        ...
        {{-- Action Buttons (Sticky Bottom) --}}
        <div class="sticky bottom-0 z-10 bg-slate-50 dark:bg-navy-800 border-t border-slate-200 dark:border-navy-600 py-4 -mx-[var(--margin-x)] px-[var(--margin-x)] mt-auto"> {{-- Kunci: 'mt-auto' di sini akan menekan tombol ke bawah jika konten kurang --}}
            <div class="flex items-center justify-end space-x-3">
