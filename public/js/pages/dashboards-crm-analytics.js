window.addEventListener(
  ...
  function () {
    ...
    var e = {
        ...
        series: [{ name: "Sales", data: [654, 820, 102, 540, 154, 614] }],
    ...
    new Popper("#project-status-menu", ".popper-ref", ".popper-root", s),
      new Popper("#satisfaction-menu", ".popper-ref", ".popper-root", s),
      new Popper("#bandwidth-menu", ".popper-ref", ".popper-root", s),
      new Popper("#users-activity-menu", ".popper-ref", ".popper-root", s);
  },
  { once: !0 }
);
