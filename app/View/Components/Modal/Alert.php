...
class Alert extends Component
{
    ...
    public function __construct(
        ...
        $configs = [
            ...
            'error' => [
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="inline size-28 shrink-0 text-error" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
            ...
            'info' => [
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="inline size-28 shrink-0 text-info" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
